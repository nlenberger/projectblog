...
Now, I will play around with the hover data lables.

```{r}
plot_ly(iris, x = ~Petal.Length, y = ~Sepal.Length, text = ~paste("Sepal Length:", Sepal.Length, ",", "Petal Length:", Petal.Length), color = ~Species)
```

For some graphcis, you might want the viewer to know what exact values they are looking at, for each point. 
